          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">
                flavioticontato@gmail.com
              </span>

              <a
                href="mailto:flavioticontato@gmail.com"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">@flavioadriano</span>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">24 998613348</span>
